...
def load_samples_sequence(anns,tracks,images_path,frames,image_size,num_boxes=12,):
    ...
    return images, bboxes, bboxes_idx, actions, activities, bboxes_center
...
class VolleyballDataset(data.Dataset):
    ...
    def load_samples_sequence(self,select_frames):
        ...
        x0=(x1+x2)/2
        y0=(y1+y2)/2
        bboxes_center=torch.cat((x0.unsqueeze(2),y0.unsqueeze(2)),dim=2)

        return images, bboxes,  actions, activities, bboxes_center
